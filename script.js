document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalImage = document.getElementById('modal-image'); // New line to get modal image element
    ...
    teamMembers.forEach(member => {
        member.addEventListener('click', () => {
            ...
            const imageUrl = member.dataset.modalImage; // Get image URL from data-modal-image
